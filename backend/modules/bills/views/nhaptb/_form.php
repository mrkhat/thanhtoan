        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                if (!$model->isNewRecord) {
                    $name = $model->roomid <> 10 ? '' : $model->roomname;
                } else {
...
//  
            ...
            <div class="form-group">
                ...
                <?= $form->field($model, 'receiver')->textInput(['maxlength' => true, 'readOnly' => $readOnly, 'value' => $model->receiver ? $model->receiver : \Yii::$app->user->identity->first_name]) ?>
            ...
            if (!$model->isNewRecord) {
                ...
                $form = ActiveForm::begin(['action' => '/nhapthietbi/create', 'options' => ['enctype' => 'multipart/form-data']])
                ?>
                ...
                <?= $form->field($model2, 'note')->hiddenInput(['maxlength' => true, 'value' => $model->note])->label(false) ?>
...
//  
                            ...
                            <td  class='col-md-4'style="height: 100px"> <?= $form->field($model2, 'note2')->textInput(["id" => 'bills-note', 'maxlength' => true]) ?></td>
                            <td  class='col-md-4'style="height: 100px"> <?= $form->field($model2, 'hslienket')->textInput(["id" => 'bills-hslienket', 'maxlength' => true]) ?></td>
...
//  
                            ...
                            <td  class='col-md-4'style="height: 100px"> <?= $form->field($model, 'note2')->textInput(["id" => 'bills-number', 'maxlength' => true]) ?></td>
                            <td  class='col-md-4'style="height: 100px"> <?= $form->field($model, 'hslienket')->textInput(["id" => 'bills-hslienket', 'maxlength' => true]) ?></td>
...
//  
                                    ...
                                    'header' => 'Tên Thiết Bị', 'size' => 'md', 'formOptions' => ['action' => ['/nhapthietbi/edititems']]];
                            },
                                    'width' => '350px',
                                ],
                                [
...
//        'headerOptions'=>['class'=>'kv-sticky-column'],
//        'contentOptions'=>['class'=>'kv-sticky-column'],
                                    'editableOptions' => ['header' => 'Số Lướng', 'size' => 'md', 'formOptions' => ['action' => ['/nhapthietbi/edititems']]],
                                ],
                                [
                                    'class' => 'kartik\grid\EditableColumn',
                                    'attribute' => 'note2',
...
//        'headerOptions'=>['class'=>'kv-sticky-column'],
//        'contentOptions'=>['class'=>'kv-sticky-column'],
                                    'editableOptions' => ['header' => 'Ghi Chú', 'size' => 'md', 'formOptions' => ['action' => ['/nhapthietbi/edititems']]],
                                    'width' => '250px'
                                ],
                                [
                                    'class' => 'kartik\grid\EditableColumn',
