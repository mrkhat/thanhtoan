...
//  
    ...
    'pluginOptions' => [
        ...
        <?= $form->field($model,'source')->dropDownList(
            ['' => '------', 'Mua Mới' => 'Mua Mới', 'Dự Phòng' => 'Dự Phòng', 'Dự Án FPT' => 'Dự Án FPT', 'Tài Trợ' => 'Tài Trợ','Sửa chữa' => 'Sửa chữa' ]
    ); ?>
            </div>
         ...
         <?php ActiveForm::end();
             ...
             $form = ActiveForm::begin(['action'=>'/bgtb/create','options' => ['enctype' => 'multipart/form-data']]) ?>
...
//  
                ...
                <td  class='col-md-4'style="height: 100px"> <?= $form->field($model2, 'note')->textInput(["id"=>'bills-number','maxlength' => true]) ?></td>
...
//  
                 ...
                 <td  class='col-md-4'style="height: 100px"> <?= $form->field($model, 'serial')->textInput(["id"=>'bills-serial','maxlength' => true]) ?></td>
                <td  class='col-md-1'style="height: 100px "id="bills-unit"> </td>
...
//  
          ...
          'width'=>'350px',
           ...
           ['class'=>'kartik\grid\ActionColumn',
                                            'header' => "Tùy Chọn",
                                            'width'=>'150px',
                                            'template' => '{delete}{printbarcode}',
                                            'buttons' => [
                                                        'printbarcode'=>function ($url, $model) {

                                                    return Html::a('<span class="n btn-default fa fa-print label-info">print </span>', $url, ['title' => "printebarcode",
