...
$roomname = empty(Yii::$app->request->queryParams['SearchXdp']['roomid']) ? '' : Room::findOne(Yii::$app->request->queryParams['SearchXdp']['roomid'])->name;


/* @var $this yii\web\View */
/* @var $searchModel backend\modules\bills\models\SearchXdp */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Xuất Dự Phòng');
...
<div class="xdp-index">
 ...
 <div class="row">
    ...
    'striped'=>true,
    'hover'=>true,
    'panel'=>['type'=>'primary', 'heading'=>'Quản Lý Phiếu Bàn Giao Thiết Bị Dự Phòng'],
//        'pjax' => true,
//            'responsive' => true,
//            'pjaxSettings' => [
//                'options' => [
...
//            ],
        'columns' => [
            ...
            ['attribute'=>'key', 
                ...
                'format' => 'raw',
                 'value' => function ($data) {
             return Html::a($data->key,['bgtb/update?id='.$data->key]); 
            ...
            // 'source',
                       ...
                       ['attribute'=>'status1',
                          ...
                          'subGroupOf'=>0,
                                           ...
                                           'value' => function ($data) {
                   $view=  Html::a('<span class="label label-success">Xem</span>', Url::to(['bgtb/view','id'=>$data->key]), [
                                                                'data-toggle' =>  "modal",'title'=>'Thông tin chi tiết phiếu', "modal", 'data-target' => "#myModal", 'class' => 'modelshow',
                                                    ]); 
                    $update=  Html::a('<i class="fa fa-pencil-square label label-warning " aria-hidden="true">Update</i>', Url::to(['bgtb/update','id'=>$data->key]) );
                         
             $role=\Yii::$app->user->identity->role;
                   $d=$role>10?$view.$update:($data->status==1?$view:$view.$update);
             return $d;
