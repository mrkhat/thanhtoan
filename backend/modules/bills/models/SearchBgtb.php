...
/**
 * SearchBgtbdien represents the model behind the search form about `backend\modules\bills\models\Bgtbdien`.
 */
class SearchBgtb extends Bgtb
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['note', 'deliver', 'receiver', 'created_date', 'display_date', 'note2', 'source', 'roomname', 'item', 'unit', 'groupname'], 'safe'],
        ];
    }
