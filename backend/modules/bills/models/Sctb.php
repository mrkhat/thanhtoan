...
/**
 * This is the model class for table "{{%bgtbnuoc}}".
 *
 * @property integer $id
 ...
 */
class Sctb extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
 ...
 public static function primaryKey(){
    ...
    /**
     * @inheritdoc
     * @return BgtbnuocQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new SctbQuery(get_called_class());
    }
