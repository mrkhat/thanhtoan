...
use backend\modules\bills\models\Bgtbdien;
use backend\modules\bills\models\Bills;
use backend\modules\bills\models\SearchBgtbdien;
 ...
 */
class BgtbdienController extends Controller
{
    /**
     * @inheritdoc
     */
  public function behaviors()
    ...
    {
        $searchModel = new SearchBgtbdien();
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            foreach(bgtbdien::find()->where(['key'=>$id])->all() as $row){
...
public function actions()
   {
        return ArrayHelper::merge(parent::actions(), [
           'edititems' => [                                       // identifier for your editable column action
               ...
               'modelClass' => Bgtbdien::className(),                // the model for the record being edited
...
//                'postOnly' => true,
    ...
    {
        if (($model = Bgtbdien::findOne(['key'=>$id])) !== null) {
            return $model;
        } else {
