...
/**
 * SearchRecive represents the model behind the search form about `backend\modules\recive\models\recive`.
 */
class SearchRecive extends recive
{
    /**
     * @inheritdoc
     */
