...
/**
 * This is the model class for table "dntt".
 *
 * @property integer $id
 ...
 */
class Dntt extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['name','money','proposal' ], 'required'],
               [['money', ], 'integer'],
            [['name', 'created_by','modified_by', 'modified','date_of_payment','proposal', 'note', 'attach', 'created','company'], 'string', 'max' => 255],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'created_by' => 'Người đề nghị',
            'money' => 'Số Tiền',
            'created' => 'Người Đề Nghị',
    ...
    /**
     * @inheritdoc
     * @return DnttQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new DnttQuery(get_called_class());
    }
