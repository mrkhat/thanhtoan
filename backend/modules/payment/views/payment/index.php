...
/* @var $searchModel backend\modules\Payment\models\PaymentPartner */
/* @var $dataProvider yii\data\ActiveDataProvider */


$this->title = Yii::t('app', 'Quản lý chi');
                                            ...
                                            'buttons' => [
                                                ...
                                                'view' => function ($url, $model) {
                                                    ...
                                                    return Html::a('<span class="label label-success">Xem</span>', $url, [
                                                                'data-toggle' =>  "modal",'title'=>'Thông tin phiếu chi', "modal", 'data-target' => "#myModal", 'class' => 'modelshow',
                                                    ]);
                                                },
